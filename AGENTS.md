...
- **M9 WS8 UI/UX Quality Pass (W8-7 `4dbc06c`, W8-8 `4f3c05d`):**
  ...
  - **Logo tile:** now a perfect circle (`BoxShape.circle`) across sidebar (32px via `BrandLogo`), splash (72px), and login (76px). Login wheat icon bumped 30→34 for better fill inside the circle. Deviates from DESIGN_SYSTEM §5 radius-22 tile (user requested circular brand mark).
